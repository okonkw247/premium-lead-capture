    ...
    return {
        ...
        html: emailWrapper('Monk Mode Protocol — Day 7 Complete', `
            ...
            <div style="background-color:#0b0a09;padding:28px;margin-bottom:28px;text-align:center;">
                ...
                <p style="color:#d4af37;font-size:22px;font-weight:700;margin:0 0 20px;">Launch Price: $17</p>
                <a href="https://adamsxproject.com/comeback" style="background-color:#d4af37;color:#0b0a09;text-decoration:none;padding:14px 32px;font-size:13px;font-weight:700;text-transform:uppercase;letter-spacing:0.15em;display:inline-block;">I'm Ready — Get Access</a>
            </div>
    ...
    return {
        ...
        html: emailWrapper('Comeback: Unrecognizable — Now Live', `
            ...
            <div style="background-color:#0b0a09;padding:28px;margin-bottom:28px;text-align:center;">
                ...
                <p style="color:#d4af37;font-size:24px;font-weight:700;margin:0 0 20px;">Launch Price: $17</p>
                <a href="https://adamsxproject.com/comeback" style="background-color:#d4af37;color:#0b0a09;text-decoration:none;padding:16px 36px;font-size:14px;font-weight:700;text-transform:uppercase;letter-spacing:0.15em;display:inline-block;">Get Access Now — $17</a>
            </div>
