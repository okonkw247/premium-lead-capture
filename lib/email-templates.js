...
function whopLink() {
    return process.env.WHOP_PRODUCT_URL || '[WHOP LINK — set WHOP_PRODUCT_URL in .env]';
}
...
function day0(firstName, email) {
    const downloadUrl = 'https://www.adamsxproject.com.ng/monk-mode-starter-kit.pdf';
    return {
...
function apologyResend(firstName, email) {
    const downloadUrl = email
        ...
        : 'https://www.adamsxproject.com.ng/monk-mode-starter-kit.pdf';
    return {
