    ...
    return {
        ...
        html: emailLayout({
            ...
            bodyHtml: `
                ...
                ${p(`It is $17. That price will not stay forever.`)}
                ${ctaButton('Get the Full Blueprint — $17', WAITLIST_URL)}
                ${signOff()}
            `
        })
    };
    ...
    return {
        ...
        html: emailLayout({
            ...
            bodyHtml: `
                ...
                ${p(`$17. Everything I know. Everything I apply. Documented and structured for you to follow.`)}
                ${ctaButton('Get the Full Blueprint — $17', WAITLIST_URL)}
                ${signOff()}
            `
        })
    ...
    return {
        ...
        html: emailLayout({
            ...
            bodyHtml: `
                ...
                ${p(`<strong>Comeback: Unrecognizable — $17.</strong> The complete 90-day system.`)}
                ${ctaButton('Get It Now — $17', WAITLIST_URL)}
