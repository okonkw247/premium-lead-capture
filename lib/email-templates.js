    ...
    return {
        ...
        html: emailLayout({
            ...
            bodyHtml: `
                ...
                <!-- EBOOK PDF: Self-hosted — forces download for subscribers -->
                ${ctaButton('Download Your Starter Kit', 'https://adamsxproject.com.ng/ebooks/the-7-day-starter-kit.pdf')}
...
// ============================================================
function apologyResend(firstName) {
    return {
...
// ============================================================
function paidEbookAccess(firstName, downloadUrl) {
